  ...
  return (
    <header className="mb-8 flex items-start justify-between gap-6">
      <div>
        ...
        <h1 className="text-3xl font-semibold tracking-[-0.03em] text-tc-text">{title}</h1>
        {subtitle && <p className="mt-2 max-w-2xl text-sm leading-6 text-tc-muted">{subtitle}</p>}
      </div>
