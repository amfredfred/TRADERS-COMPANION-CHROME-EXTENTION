...
export default function TradeReviewTab({ intentId, direction, symbol }: Props) {
  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 tc-scrollbar">
          ...
          <div className="mt-3 space-y-2">
            {checks.map(check => (
              ...
              >
                ...
                <span className={`text-xs ${check.pass === false ? 'text-tc-amber' : 'text-tc-muted'}`}>
                  {check.detail}
                </span>
              </div>
            ))}
